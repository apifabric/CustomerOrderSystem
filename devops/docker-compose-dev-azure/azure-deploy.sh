...
resourcename="customerordersystem"  # lower case, only
resourcegroup="customerordersystem_rg"
...
# git clone https://github.com/apilogicserver/customerordersystem.git
...
az group create --name customerordersystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group customerordersystem_rg --sku S1 --is-linux
az container create --resource-group customerordersystem_rg --name customerordersystem --image apilogicserver/customerordersystem:latest --dns-name-label customerordersystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//customerordersystem.westus.azurecontainer.io:5656'
